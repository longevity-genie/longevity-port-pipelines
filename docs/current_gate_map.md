...
| Gate 8 - long-lived vs short-lived contrast | Compute technical contrast under gate policy. | Implemented as a SIRT6 technical checkpoint; generic Gate 8 gated contrast schema, helper, and runtime calculator now exist. |
...
- the next major frontier is wiring the generic gated contrast runtime into calibration lanes and adding contrast robustness flags
