...
| Gate 7 - strict panel / contrast gate | Decide whether a candidate may enter technical contrast. | Advanced for SIRT6; generic strict contrast panel schema exists. A fully generic runtime builder is still pending. |
